...
//----------------------------------------------------------------------------------------------------
float Glyph3::Vector4f::Magnitude() const
{
	float fLength = 0.0f;
...
//----------------------------------------------------------------------------------------------------
void Vector4f::fromRGBA(unsigned int color)
{
	x = (float)((color & 0xff000000) >> 24) / (255.0f);
	y = (float)((color & 0x00ff0000) >> 16) / (255.0f);
	z = (float)((color & 0x0000ff00) >> 8) / (255.0f);
	w = (float)(color & 0x000000ff) / (255.0f);
}
//----------------------------------------------------------------------------------------------------
...
Glyph3::Vector4f Glyph3::Vector4f::Normalize(const Vector4f& v)
{
	float mag = v.Magnitude();
	return Vector4f(v.x / mag, v.y / mag, v.z / mag, v.w / mag);
}

Glyph3::Vector3f Glyph3::Vector4f::Projection() const
{
