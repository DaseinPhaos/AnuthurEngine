...
//----------------------------------------------------------------------------------------------------
Matrix4x4f::Matrix4x4f(bool bZero)
{
	if (bZero)
		memset(m_afEntry, 0, 4 * 4 * sizeof(float));
}
//----------------------------------------------------------------------------------------------------
Matrix4x4f::Matrix4x4f(const Matrix4x4f& Matrix)
{
	memcpy(m_afEntry, (void*)&Matrix, 16 * sizeof(float));
}
//----------------------------------------------------------------------------------------------------
Matrix4x4f::Matrix4x4f(float fM11, float fM12, float fM13, float fM14,
...
//----------------------------------------------------------------------------------------------------
void Matrix4x4f::RotationX(float fRadians)
{
...
//----------------------------------------------------------------------------------------------------
void Matrix4x4f::RotationY(float fRadians)
{
	float fSin = sinf(fRadians);
	float fCos = cosf(fRadians);
...
//----------------------------------------------------------------------------------------------------
void Matrix4x4f::RotationZ(float fRadians)
{
	float fSin = sinf(fRadians);
	float fCos = cosf(fRadians);
...
//----------------------------------------------------------------------------------------------------
void Matrix4x4f::Scale(float fScale)
{
	m_afEntry[0] = fScale;
	m_afEntry[1] = 0.0f;
	m_afEntry[2] = 0.0f;
...
//----------------------------------------------------------------------------------------------------
void Matrix4x4f::Translate(float fX, float fY, float fZ)
{
	m_afEntry[0] = 1.0f;
	m_afEntry[1] = 0.0f;
	m_afEntry[2] = 0.0f;
...
//----------------------------------------------------------------------------------------------------
Vector3f Matrix4x4f::GetBasisX() const
{
	Vector3f Basis;
...
//----------------------------------------------------------------------------------------------------
Vector3f Matrix4x4f::GetBasisY() const
{
	Vector3f Basis;
...
//----------------------------------------------------------------------------------------------------
Vector3f Matrix4x4f::GetBasisZ() const
{
	Vector3f Basis;
...
//----------------------------------------------------------------------------------------------------
Vector3f Matrix4x4f::GetTranslation() const
{
	Vector3f Pos;
...
//----------------------------------------------------------------------------------------------------
void Matrix4x4f::SetTranslation(const Vector3f& Trans)
{
	for (int i = 0; i < 3; i++)
		m_afEntry[I(3, i)] = Trans[i];
}
//----------------------------------------------------------------------------------------------------
Matrix3x3f Matrix4x4f::GetRotation() const
{
	Matrix3x3f mRet;
...
//----------------------------------------------------------------------------------------------------
void Matrix4x4f::SetRotation(const Matrix3x3f& Rot)
{
	for (int i = 0; i < 3; i++)
		for (int j = 0; j < 3; j++)
...
//----------------------------------------------------------------------------------------------------
Matrix4x4f Matrix4x4f::RotationMatrixXYZ(float fRadiansX, float fRadiansY, float fRadiansZ)
{
	//Matrix4f mRot1;
	//Matrix4f mRot2;
	//
	...
	return Matrix4x4f::RotationMatrixZ(fRadiansZ) * Matrix4x4f::RotationMatrixX(fRadiansX) * Matrix4x4f::RotationMatrixY(fRadiansY);
}
//----------------------------------------------------------------------------------------------------
Matrix4x4f Matrix4x4f::RotationMatrixX(float fRadians)
{
	Matrix4x4f ret;
...
//----------------------------------------------------------------------------------------------------
Matrix4x4f Matrix4x4f::RotationMatrixY(float fRadians)
{
	Matrix4x4f ret;
...
//----------------------------------------------------------------------------------------------------
Matrix4x4f Matrix4x4f::RotationMatrixZ(float fRadians)
{
	Matrix4x4f ret;
...
//----------------------------------------------------------------------------------------------------
Matrix4x4f Matrix4x4f::ScaleMatrix(float fScale)
{
	Matrix4x4f ret;
	ret.Scale(fScale);
	return(ret);
...
//----------------------------------------------------------------------------------------------------
Matrix4x4f Matrix4x4f::ScaleMatrix(const Vector3f& scale)
{
	Matrix4x4f ret;
...
//----------------------------------------------------------------------------------------------------
Matrix4x4f Matrix4x4f::ScaleMatrixXYZ(float fX, float fY, float fZ)
{
	Matrix4x4f ret;
...
//----------------------------------------------------------------------------------------------------
Matrix4x4f Matrix4x4f::TranslationMatrix(float fX, float fY, float fZ)
{
	Matrix4x4f ret;
...
//----------------------------------------------------------------------------------------------------
Matrix4x4f Matrix4x4f::LookAtLHMatrix(Vector3f& eye, Vector3f& at, Vector3f& up)
{
...
//----------------------------------------------------------------------------------------------------
Matrix4x4f Matrix4x4f::PerspectiveFovLHMatrix(float fovy, float aspect, float zn, float zf)
{
	// This method is based on the method of the same name from the D3DX library.
...
//----------------------------------------------------------------------------------------------------
Matrix4x4f Matrix4x4f::OrthographicLHMatrix(float zn, float zf, float width, float height)
{
	// This method is based on the method of the same name from the D3DX library.
...
//----------------------------------------------------------------------------------------------------
float Matrix4x4f::operator[] (int iPos) const
{
	return(m_afEntry[iPos]);
}
//----------------------------------------------------------------------------------------------------
float& Matrix4x4f::operator[] (int iPos)
{
	return(m_afEntry[iPos]);
}
//----------------------------------------------------------------------------------------------------
float Matrix4x4f::operator() (int iRow, int iCol) const
{
	return(m_afEntry[I(iRow, iCol)]);
}
//----------------------------------------------------------------------------------------------------
float& Matrix4x4f::operator() (int iRow, int iCol)
{
	return(m_afEntry[I(iRow, iCol)]);
}
//----------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------
Matrix4x4f Matrix4x4f::operator* (float fScalar) const
{
	Matrix4x4f mProd;
...
//----------------------------------------------------------------------------------------------------
Matrix4x4f& Matrix4x4f::operator*= (float fScalar)
{
	for (int i = 0; i < 4 * 4; i++)
		m_afEntry[i] *= fScalar;
...
{
	Matrix4x4f mReturn = Matrix4x4f(true);
...
//----------------------------------------------------------------------------------------------------
int Matrix4x4f::I(int iRow, int iCol)
{
	return(4 * iRow + iCol);
}
//----------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------
void Matrix4x4f::SetRow(int iRow, const Vector4f& Vector)
{
	for (int iCol = 0; iCol < 4; iCol++)
		m_afEntry[I(iRow, iCol)] = Vector[iCol];
}
//----------------------------------------------------------------------------------------------------
void Matrix4x4f::SetRow(int iRow, const Vector3f& Vector)
{
	for (int iCol = 0; iCol < 3; iCol++)
		m_afEntry[I(iRow, iCol)] = Vector[iCol];
}
//----------------------------------------------------------------------------------------------------
Vector4f Matrix4x4f::GetRow(int iRow) const
{
	Vector4f vRow;
	for (int iCol = 0; iCol < 4; iCol++)
...
//----------------------------------------------------------------------------------------------------
void Matrix4x4f::SetColumn(int iCol, const Vector4f& Vector)
{
	for (int iRow = 0; iRow < 4; iRow++)
		m_afEntry[I(iRow, iCol)] = Vector[iRow];
}
//----------------------------------------------------------------------------------------------------
Vector4f Matrix4x4f::GetColumn(int iCol) const
{
	Vector4f vCol;
	for (int iRow = 0; iRow < 4; iRow++)
...
float Glyph3::Matrix4x4f::Determinant() const
{

	float m00 = m_afEntry[0], m01 = m_afEntry[1], m02 = m_afEntry[2], m03 = m_afEntry[3],
		m10 = m_afEntry[4], m11 = m_afEntry[5], m12 = m_afEntry[6], m13 = m_afEntry[7],
		m20 = m_afEntry[8], m21 = m_afEntry[9], m22 = m_afEntry[10], m23 = m_afEntry[11],
		m30 = m_afEntry[12], m31 = m_afEntry[13], m32 = m_afEntry[14], m33 = m_afEntry[15];

	return m00*(m11*m22*m33 + m12*m23*m31 + m13*m21*m32 - m13*m22*m31 - m12*m21*m33 - m11*m23*m32)
		+ m01*(m13*m22*m30 + m12*m20*m33 + m10*m23*m32 - m10*m22*m33 - m12*m23*m30 - m13*m20*m32)
		+ m02*(m10*m21*m33 + m11*m23*m30 + m13*m20*m31 - m13*m21*m30 - m11*m21*m33 - m10*m23*m31)
		+ m03*(m12*m21*m30 + m11*m20*m32 + m10*m22*m31 - m10*m21*m33 - m11*m22*m30 - m12*m20*m31);
}
